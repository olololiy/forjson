    ...
    const section = document.querySelector('section');                              //ссылки на section
    var requestURL = 
    'https://mdn.github.io/learning-area/javascript/oojs/json/superheroes.json';    //сохранили ссылку в переменную
